	...
	public function webtoffee_serialize($search = '', $replace = '', $data = '', $serialised = FALSE)
	{
		if (is_string($data) && ($unserialized = @unserialize($data)) !== FALSE) {
			...
			$props = get_object_vars($data);
                        $invalid_object_class = (isset($props['__PHP_Incomplete_Class_Name']) && $props['__PHP_Incomplete_Class_Name'])? $props['__PHP_Incomplete_Class_Name']:'';
