...
<div style="padding-top:15px; padding-bottom:35px;">
    <div style="display:inline-flex"><h3><?php _e('Export','wp-migration-duplicator');?></h3><div id="loading" class="wf_export_loader" style="display:none;"></div></div>

	<p><?php _e('A clone of the wp-contents is generated in a zip format. For a smooth migration, you can also replace the text within the database file with the destination\'s text.','wp-migration-duplicator');?>
		<br />
		...
		<tr class="">
			<td>
				<p style="margin-top:15px; float:left;">
					<?php _e(sprintf('Find and replace %stext%s with %sanother text%s in the database.</br></br>','<b>&lt;','&gt;</b>','<b>&lt;','&gt;</b>'),'wp-migration-duplicator'); ?>
